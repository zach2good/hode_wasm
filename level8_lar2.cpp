...
static const CheckpointData _lar2_checkpointData[12] = {
    { 111, 123, 0x300c, 48, 0, 0 }, { 11, 123, 0x300c, 48, 2, 0 },  { 17, 51, 0x300c, 48, 4, 0 },
    { 69, 91, 0x300c, 48, 6, 0 },   { 154, 91, 0x700c, 48, 6, 0 },  { 154, 91, 0x700c, 48, 6, 0 },
    { 137, 35, 0x300c, 48, 11, 0 }, { 154, 91, 0x700c, 48, 6, 0 },  { 70, 139, 0x700c, 48, 5, 0 },
    { 106, 139, 0x700c, 48, 4, 0 }, { 75, 107, 0x300c, 48, 15, 0 }, { 75, 107, 0x300c, 48, 15, 0 }
};

static const uint8_t _lar2_screenStartData[64] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static BoundingBox _lar2_switchesBbox[13] = { { 210, 155, 220, 159 }, { 224, 146, 234, 150 }, { 193, 84, 203, 88 },
                                              { 209, 83, 219, 87 },   { 65, 179, 75, 183 },   { 65, 179, 75, 183 },
                                              { 145, 179, 155, 183 }, { 145, 179, 155, 183 }, { 224, 179, 234, 183 },
                                              { 16, 84, 26, 88 },     { 16, 84, 26, 88 },     { 16, 164, 26, 168 },
                                              { 16, 164, 26, 168 } };

static uint8_t _lar2_switchesData[13 * 4] = { // screenNum,state,spriteNum,gateNum
    0x03, 0x07, 0x00, 0x01, 0x0A, 0x07, 0x00, 0x04, 0x09, 0x03, 0x00, 0x07, 0x08, 0x03, 0x00, 0x07, 0x0B, 0x17,
    0x00, 0x06, 0x0B, 0x15, 0xFF, 0x05, 0x0B, 0x15, 0x01, 0x06, 0x0B, 0x17, 0xFF, 0x05, 0x0B, 0x17, 0x02, 0x06,
    0x0D, 0x05, 0x00, 0x09, 0x0D, 0x07, 0xFF, 0x08, 0x0D, 0x05, 0x01, 0x08, 0x0D, 0x07, 0xFF, 0x09
};

static const uint8_t _lar2_setupScreen19Data[13 * 3] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x02,
                                                         0x00, 0x00, 0x02, 0x00, 0x00, 0x02, 0x00, 0x00, 0x05, 0x02,
                                                         0x00, 0x02, 0x00, 0x00, 0x03, 0x00, 0x00, 0x09, 0x0C, 0x00,
                                                         0x0A, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
...
void Level_lar2::postScreenUpdate_lar2_screen11()
{
    ...
    int offset = 0x18;
    if ((_lar2_switchesData[0x11] & 1) == 0 && (_lar2_switchesData[0x11] & 0x40) != 0
        && (_lar2_switchesData[0x19] & 1) == 0)
    {
    ...
    if ((_lar2_switchesData[0x21] & 1) == 0 && (_lar2_switchesData[0x21] & 0x40) != 0
        && (_lar2_switchesData[offset + 1] & 1) == 0)
    {
...
void Level_lar2::setupScreenCheckpoint_lar2_screen19()
{
    ...
    static const uint8_t data[17] = { 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x01,
