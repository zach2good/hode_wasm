...
static const CheckpointData _isld_checkpointData[5] = { { 46, 84, 0x300c, 207, 0, 2 },
                                                        { 99, 48, 0x300c, 39, 3, 2 },
...
static const uint8_t _isld_stairsDxTable[] = { 0, 1, 2, 3, 5, 7, 9, 10, 11, 12, 12, 12, 12, 11, 10, 9,
...
void Level_isld::postScreenUpdate_isld_screen3()
{
    if (_res->_currentScreenResourceNum == 3)
    {
        if (_andyObject->xPos < 150)
        {
            ...
            if (o)
            {
                AnimBackgroundData* backgroundData =
                    (AnimBackgroundData*)_g->getLvlObjectDataPtr(o, kObjectDataTypeAnimBackgroundData);
...
void Level_isld::postScreenUpdate_isld_screen15()
{
    ...
    case 2:
        ...
        break;
    case 0:
        if (_res->_currentScreenResourceNum == 15 && (_andyObject->flags0 & 0x1F) == 1
            && (_andyObject->flags0 & 0x30) == 0)
        {
