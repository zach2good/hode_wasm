...
static const CheckpointData _rock_checkpointData[8] = {
    { 96, 34, 0x300c, 22, 0, 0 },    { 10, 126, 0x300c, 48, 2, 0 }, { 6, 128, 0x300c, 48, 4, 0 },
    { 18, 125, 0x300c, 48, 5, 0 },   { 21, 124, 0x300c, 48, 7, 0 }, { 105, 52, 0x3004, 232, 9, 2 },
    { 18, 121, 0x3004, 232, 13, 2 }, { 43, 96, 0x3004, 39, 17, 2 }
};

static const uint8_t _rock_screenStartData[56] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x01, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
    0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x30, 0x00, 0x00, 0x01, 0x40,
    0x02, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
static const uint8_t _level1OpHelper1KeyMaskTable[112] = {
    8, 0, 8, 0, 8, 0, 8, 0, 8, 4, 9, 0, 9, 0, 9, 4, 9, 0, 9, 0, 8, 4, 9, 0, 9, 4, 8, 0, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4,
    8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 2, 4, 2, 4, 2, 4, 2, 4, 2, 4, 2, 4, 2, 4, 2, 4, 3, 0, 2, 4, 3, 0, 2, 4, 3, 4, 2, 0,
    2, 4, 2, 4, 8, 0, 8, 0, 8, 0, 8, 0, 8, 0, 8, 4, 8, 4, 4, 0, 8, 4, 8, 4, 8, 4, 8, 4, 8, 4, 8, 0, 8, 0, 4, 0
};
...
bool Game::plasmaCannonHit(LvlObject* ptr)
{
    ...
    if (ptr->bitmapBits)
    {
        ...
        if (testPlasmaCannonPointsDirection(
                ptr->xPos + dx, ptr->yPos, ptr->xPos + dx + ptr->width, ptr->yPos + ptr->height))
        {
            return true;
        }
...
{
    static uint8_t data[68] = { 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02,
                                0x02, 0x02, 0x02, 0x02, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x04, 0x00, 0x00, 0x00,
                                0x00, 0x00, 0x00, 0x00, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x80, 0x80, 0x80, 0x80,
                                0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
                                0x80, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x0C, 0x07, 0x00, 0x00 };
...
{
    static uint8_t data[68] = { 0x00, 0x00, 0x00, 0x00, 0x05, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06,
                                0x06, 0x06, 0x06, 0x06, 0x06, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x00,
                                0x00, 0x00, 0x00, 0x00, 0x04, 0x04, 0x04, 0x04, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
                                0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x02, 0x02, 0x02, 0x02, 0x02,
                                0x02, 0x02, 0x02, 0x04, 0x04, 0x04, 0x04, 0x04, 0x06, 0x0B, 0x00, 0x00 };
