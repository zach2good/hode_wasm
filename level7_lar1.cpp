...
static const CheckpointData _lar1_checkpointData[9] = {
    { -8, 145, 0x300c, 207, 0, 2 },  { 60, 49, 0x300c, 232, 2, 2 },   { 6, 41, 0x300c, 232, 6, 2 },
    { 32, 37, 0x300c, 232, 8, 2 },   { 172, 105, 0x300c, 232, 9, 2 }, { 40, 145, 0x300c, 232, 14, 2 },
    { 213, 25, 0x700c, 232, 16, 2 }, { 123, 57, 0x300c, 232, 20, 2 }, { 224, 43, 0x700c, 232, 5, 2 }
};

static const uint8_t _lar1_screenStartData[56] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x02, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x01, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
static BoundingBox _lar1_switchesBbox[24] = { { 203, 162, 213, 166 }, { 68, 86, 78, 90 },     { 195, 58, 205, 62 },
                                              { 111, 171, 125, 175 }, { 111, 171, 125, 175 }, { 202, 171, 212, 175 },
                                              { 158, 29, 170, 57 },   { 158, 29, 170, 57 },   { 158, 29, 170, 57 },
                                              { 158, 29, 170, 57 },   { 230, 139, 242, 167 }, { 230, 139, 242, 167 },
                                              { 230, 139, 242, 167 }, { 86, 37, 98, 65 },     { 86, 37, 98, 65 },
                                              { 86, 37, 98, 65 },     { 238, 18, 250, 46 },   { 14, 138, 26, 166 },
                                              { 14, 138, 26, 166 },   { 51, 157, 61, 161 },   { 51, 157, 61, 161 },
                                              { 51, 157, 61, 161 },   { 202, 157, 212, 161 }, { 32, 145, 44, 173 } };
...
static const uint8_t _lar1_setupScreen24Data[8 * 3] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
                                                        0x00, 0x00, 0x03, 0x00, 0x02, 0x08, 0x02, 0x0B,
...
void Level_lar1::postScreenUpdate_lar1_screen12()
{
    if (_res->_currentScreenResourceNum == 12)
    {
        ...
        {
            static const uint8_t data[8 * 4] = { 0x05, 0x00, 0x00, 0x04, 0x06, 0x00, 0x00, 0x00, 0x07, 0xFB, 0x04,
                                                 0x05, 0x08, 0xFA, 0x04, 0x05, 0x09, 0xF9, 0x00, 0x00, 0x0A, 0x00,
                                                 0x00, 0x04, 0xF8, 0xF7, 0x00, 0x04, 0x00, 0x00, 0x00, 0x04 };
            const uint8_t num = (_andyObject->flags0 >> 5) & 7;
            const int offset = counter * 4;
            if (data[offset + 2] == num || data[offset + 3] == num)
            {
                BoundingBox b[] = { { 205, 0, 227, 97 },  { 200, 16, 207, 55 },   { 128, 16, 159, 71 },
                                    { 56, 32, 87, 87 },   { 179, 112, 207, 167 }, { 179, 64, 207, 103 },
                                    { 32, 112, 87, 167 }, { 32, 112, 87, 167 } };
                AndyLvlObjectData* andyData =
                    (AndyLvlObjectData*)_g->getLvlObjectDataPtr(_andyObject, kObjectDataTypeAndy);
    ...
    if (_res->_currentScreenResourceNum == 14)
    {
        ...
        case 3:
            ...
            else if (_screenCounterTable[14] >= 20)
            {
                ...
                _screenCounterTable[14] == 7 || _screenCounterTable[14] == 9 || _screenCounterTable[14] == 11
                || _screenCounterTable[14] == 13 || _screenCounterTable[14] == 15)
            {
                _g->setShakeScreen(3, 2);
            }
            break;
...
{
    static const uint8_t data[8 * 6] = { 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, // checkpoint, gate states
                                         0x08, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x01, 0x00, 0x01, 0x01,
                                         0x01, 0x08, 0x01, 0x01, 0x01, 0x01, 0x01, 0x03, 0x00, 0x00, 0x00,
                                         0x00, 0x00, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03, 0x01, 0x00,
                                         0x00, 0x01, 0x01, 0x03, 0x01, 0x01, 0x00, 0x01, 0x01 };
